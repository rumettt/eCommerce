...
const CartConfirmation = () => {
    ...
    const params = useParams<{status:string|string[]}>();
  ...
  return (
    <>
    {(!loading && error.current) && <CartFailed/>}
    ...
    <div className="bg-white flex items-center justify-center h-screen relative">
      <div className="bg-gray-50 border-2 flex relative gap-5 items-center flex-col text-gray-800 p-6 rounded-lg shadow-lg max-w-[90%] w-full text-center">
        ...
        <h2 className="text-2xl font-bold mb-2">Your cart orders are Confirmed!</h2>
        <p className="mb-6">
          Your Cart orders will be processed within 24 hours during working days. We will notify you by email once your order has been shipped.
        </p>
